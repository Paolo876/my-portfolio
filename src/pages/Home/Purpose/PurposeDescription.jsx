  ...
  return (
    <Box mb={{xs: 5, md: 0}}>
      <Box sx={{display: "flex", width: "fit-content", alignItems: "center", flexDirection: {xs:"row", md: "column"}, gap: 1}}>
        <Box sx={{filter: "invert(.6) brightness(.9)", height: {xs:"40px",sm:"50px", md: "55px", lg:"60px"}, width: {xs:"40px",sm:"50px", md: "55px", lg:"60px"}, mr:"auto", border: 3, borderRadius: 1, p: {xs:.75, md:1}, borderColor: "primary.main", mb: {xs:0, md: .5, lg: .75}}}>
          <SkillIconImageItem src={serviceIcon} objectFit='scale-down'/>
        </Box>
        <Typography variant="h4" align="left" fontSize={{xs:25, sm: 28, md: 32, lg: 35}} letterSpacing={{xs:1.5, md: 4}} sx={{opacity: .6}} color="secondary.main">Purpose</Typography>
      </Box>
      ...
      <Typography variant="body1" fontSize={{xs:13, sm: 15, md: 16, lg: 17}} sx={{mixBlendMode: "difference"}} letterSpacing={.05} fontWeight={300}>
