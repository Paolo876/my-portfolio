...
const Purpose = () => {
  return (
    <Box sx={{position: "relative"}}>
      ...
      <Grid container sx={{px: {xs:1, sm: 2, md: 1.5, lg: 3}, py: {xs:2, sm: 3, md: 5, lg: 7}, justifyContent: "center", alignItems: "flex-start", maxWidth: "1500px", mx: "auto"}}>
        <Grid item xs={12} md={6} lg={5.5} px={2}>
          <PurposeDescription/>
        </Grid>
        <Grid item xs={12} md={6} lg={5.5} px={2}>
          <MissionDescription/>
