...
const DescriptionGridItem = () => {
  ...
  return (
    <Stack >
      <Box sx={{opacity: .95, mixBlendMode: "difference"}}>
        ...
        <Typography sx={{display: "inline", fontWeight: 800, fontSize: {xs: 37, sm: 50, md: 56, lg:62, xl: 75}, ml: {xs:.25, sm:1}, lineHeight: 1.25, letterSpacing: {xs:.5, md: 1}, fontFamily: "Manrope"}}>Paolo Bugarin</Typography>
        <Typography sx={{display: "inline", fontWeight: 200, fontSize:  {xs: 20, sm: 22, md: 30, lg:36, xl: 45}, mixBlendMode: "difference"}}>,</Typography>
      </Box>
      <Box sx={{mixBlendMode: "difference", opacity:.6, mt: {sm:1, md:1.25, lg: 2}}}>
