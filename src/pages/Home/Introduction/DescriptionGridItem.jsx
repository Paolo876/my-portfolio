  ...
  return (
    <Stack pr={1.25}>
      <Box>
        ...
        <Typography sx={{display: "inline", fontWeight: 200, fontSize: 30, mixBlendMode: "difference"}}>I am </Typography>
      ...
      <Box mt={1.5}>
        <Typography sx={{display: "inline", fontWeight: 200, fontSize: 25, mixBlendMode: "difference"}}>a  </Typography>
      ...
      <Box mt={1.5}>
        <Typography sx={{display: "inline", fontWeight: 200, fontSize: 22, mixBlendMode: "difference"}}>I design and develop websites from a </Typography>
