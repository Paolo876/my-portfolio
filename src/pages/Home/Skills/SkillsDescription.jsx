...
const SkillsDescription = () => {
  return (
    <Stack p={1}>
      <Box>
        <Typography sx={{display: "inline", fontWeight: 200, fontSize: 18, opacity: .8, lineHeight: 1.75}}>I studied </Typography>
        <Typography sx={{display: "inline", fontWeight: 400, fontSize: 18, opacity: .8, lineHeight: 1.75}}>Computer Information Systems </Typography>
      ...
      <Box mt={2}>
        <Typography sx={{display: "inline", fontWeight: 200, fontSize: 18, opacity: .8, lineHeight: 1.75}}>I mainly develop my projects using </Typography>
        <Typography sx={{display: "inline", fontWeight: 400, fontSize: 18, opacity: .8, lineHeight: 1.75}}>ReactJS </Typography>
        <Typography sx={{display: "inline", fontWeight: 200, fontSize: 18, opacity: .8, lineHeight: 1.75}}>or </Typography>
        <Typography sx={{display: "inline", fontWeight: 400, fontSize: 18, opacity: .8, lineHeight: 1.75}}>NextJS </Typography>
        <Typography sx={{display: "inline", fontWeight: 200, fontSize: 18, opacity: .8, lineHeight: 1.75}}>in the Client-Side, and </Typography>
        <Typography sx={{display: "inline", fontWeight: 400, fontSize: 18, opacity: .8, lineHeight: 1.75}}>NodeJS </Typography>
        <Typography sx={{display: "inline", fontWeight: 200, fontSize: 18, opacity: .8, lineHeight: 1.75}}>and </Typography>
