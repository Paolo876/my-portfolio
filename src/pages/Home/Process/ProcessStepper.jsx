    ...
    <Stepper alternativeLabel connector={<ColorlibConnector />} activeStep={3}>
      {processItems.map(item => <Step key={item.title}>
        <StepLabel StepIconComponent={ColorlibStepIcon}>
          ...
          <Typography variant="body1" fontSize={{md: 13.5, lg:14, xl: 15}} fontWeight={400} px={{md: .5, lg:1, xl:3}} mt={{md: 2, lg:2, xl: 3.5}} sx={{textAlign: "justify", textJustify: "inter-word", opacity: .7}}>
            {item.body}
          </Typography>
        </StepLabel>
      </Step>)}
