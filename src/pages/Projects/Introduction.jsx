...
const Introduction = () => {
  ...
  return (
    <Grid container sx={{pl: {md: 4, lg: 0}, pr: {md: 4, lg: 4, xl: 9}}}>
      <Grid item xs={12} sm={4.5} md={4} lg={12}>
        <Typography 
          variant="h2" 
          align="left" 
          fontWeight={400}
          fontSize={{xs: 35, sm: 45, md: 60, lg: 80, xl: 70}} 
      ...
      <Grid item xs={12} sm={6.5} md={7} lg={12} mt={{xs: 1.25, sm: 1.25, md:3, lg: 6}} ml={{sm:1, md: .5}}>
        <Typography 
          variant="body1" 
          sx={{
