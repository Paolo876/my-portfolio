    ...
    <Grid container sx={{pl: {md: 4, lg: 0}, pr: {md: 4, lg: 4, xl: 0}}}>
      <Grid item xs={12} sm={4.5} md={4} lg={8} xl={8.5}>
        <Typography 
          ...
          align="left" 
          fontWeight={400}
          fontSize={{xs: 35, sm: 45, md: 60, lg: 80, xl: 65}} 
      ...
      <Grid item xs={12} sm={6.5} md={7} lg={8} xl={8.5} mt={{xs: 1.25, sm: 1.25, md:3, lg: 6}} ml={{sm:.25, md: .25}}>
        <Typography 
          variant="body1" 
          sx={{
            fontSize: {xs: 11.5, sm: 14.5, md: 15, lg:15, xl: 15},
            fontWeight: 300,
            opacity: .5,
            letterSpacing: .4,
