...
const Introduction = () => {
  ...
  return (
    <Grid container sx={{pl: {md: 4, lg: 0}, pr: {md: 4, lg: 0}}}>
      ...
      <Grid item xs={12} sm={6.5} md={7} lg={12} mt={{xs: 1.25, sm: 1.25, md:3, lg: 8}} ml={{sm:1, md: 0}}>
        <Typography 
          variant="body1" 
          fontSize={{xs: 12, sm: 12, md: 13, lg:14, xl: 15}} 
          fontWeight={200} 
          sx={{textAlign: "justify", textJustify: "inter-word", mixBlendMode: "difference", opacity: .9}}
        >
