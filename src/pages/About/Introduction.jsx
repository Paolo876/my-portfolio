...
const baseTextStyles = {
  fontSize:{xs: 12, sm: 13, md: 13.5, lg:14, xl: 15.5},
  fontWeight: 300,
  textAlign: "justify", 
...
const Introduction = () => {
  return (
    ...
    >      
      <Grid item md={6} lg={5.5} order={{sm: 2, md:1}} mt={{sm: 6, md: 0}}>
        <Box>
          <Typography 
            variant="h1" 
            align="left" 
      ...
      <Grid item xs={12} md={6} lg={6.5}  order={{sm: 1, md:2}} sx={{display: "flex", justifyContent: "right"}}>
        <Box 
          sx={{
            border: 3, 
            borderRadius: "50%", 
