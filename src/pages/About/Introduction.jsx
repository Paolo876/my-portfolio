      ...
      <Box sx={{background: "white", height: "4px", width: "25px", my: 4}}></Box>
        ...
        <Grid container sx={{justifyContent: "center", alignItems: "flex-start", mx: "auto", mixBlendMode: "difference"}}>
          <Grid item xs={12} md={6.5} px={1}>
            <Typography variant="body1" mb={4} fontWeight={200} fontSize={19} letterSpacing={.25} lineHeight={1.75}>
              I am <Box sx={boxTextStyles} component="span" color="primary.light">Paolo Bugarin</Box>, a <Box sx={boxTextStyles} component="span">Full Stack Web Developer </Box> 
